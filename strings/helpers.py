...
# ── inside helpers.py ────────────────────────────────────────────────
HELP_1_PROMO = """
<b><u>ᴛʜăɴɢ ᴄʜứᴄ ⁄ ɢɪáɴ ᴄʜứᴄ</u></b>
ᴄáᴄ ʟệɴʜ ᴄó sẵɴ ᴄʜᴏ ᴠɪệᴄ ᴅᴜʏ ᴛʀì, ᴛʜăɴɢ ᴄʜứᴄ (ᴄʜỉ ᴅàɴʜ ᴄʜᴏ Qᴜảɴ ᴛʀị):

• /promote <ɴɢườɪ ᴅùɴɢ>: ᴄấᴘ ᴘʜéᴘ Qᴜảɴ ᴛʀị ɢɪớɪ ʜạɴ. (ᴄó ᴛʜể ᴅùɴɢ ʀᴇᴘʟʏ, @ᴛêɴɴɢườɪᴅùɴɢ ʜᴏặᴄ ID)
• /fullpromote <ɴɢườɪ ᴅùɴɢ>: ᴄấᴘ ᴛấᴛ ᴄả ᴄáᴄ ᴘʜéᴘ Qᴜảɴ ᴛʀị ᴄó ᴛʜể ᴄʜᴏ ɴɢườɪ ᴅùɴɢ.
• /demote <ɴɢườɪ ᴅùɴɢ>: ɢỡ ʙỏ ᴛấᴛ ᴄả Qᴜảɴ ᴛʀị ᴄʜᴏ ɴɢườɪ ᴅùɴɢ.
• /tempadmin <ɴɢườɪ ᴅùɴɢ> x(ᴍ /ʜ /ᴅ): ᴛʜăɴɢ ᴄʜứᴄ ᴛạᴍ ᴛʜờɪ ᴛʀᴏɴɢ x ᴛʜờɪ ɢɪᴀɴ. ᴛự ᴅộɴɢ ɢɪáɴ ᴄʜứᴄ sᴀᴜ x. (ᴠᴅ: • /tempadmin @ɴɢườɪᴅùɴɢ 3ʜ)

<b>➤ ᴛấᴛ ᴄả ʟệɴʜ ʜỗ ᴛʀợ:</b> ʀᴇᴘʟʏ, @ᴛêɴɴɢườɪᴅùɴɢ, ʜᴏặᴄ ID ɴɢườɪ ᴅùɴɢ
"""


HELP_1_PUNISH = """
<b><u>ᴛʀừ ᴘʜạᴛ ⁄ ᴋɪểᴍ sᴏáᴛ</u></b>
ᴄáᴄ ʟệɴʜ ᴄó sẵɴ ᴄʜᴏ ᴅᴜʏ ᴛʀì, ᴛʀừ ᴘʜạᴛ (ᴄʜỉ ᴅàɴʜ ᴄʜᴏ Qᴜảɴ ᴛʀị):

 • /ban <ɴɢườɪ ᴅùɴɢ>: ᴄấᴍ ᴠĩɴʜ ᴠɪễɴ ɴɢườɪ ᴅùɴɢ ᴋʜỏɪ ɴʜóᴍ.
 • /unban <ɴɢườɪ ᴅùɴɢ>: ʜᴜỷ ʟệɴʜ ᴄấᴍ.
 • /kick <ɴɢườɪ ᴅùɴɢ>: ᴛạᴍ ᴛʜờɪ ʀᴜᴛ ɴɢườɪ ᴅùɴɢ ʀᴀ ᴋʜỏɪ ɴʜóᴍ. (ᴛự ᴛʜáᴏ ᴄấᴍ sᴀᴜ 2ɢɪâʏ)
 • /kickme: ᴛự ʀᴜᴛ ᴋʜỏɪ ɴʜóᴍ. (ᴛự ᴛʜáᴏ ᴄấᴍ sᴀᴜ 3ɢɪâʏ)
 • /mute <ɴɢườɪ ᴅùɴɢ>: ᴄấᴍ ɴɢườɪ ᴅùɴɢ ɢửɪ ᴛɪɴ ɴʜắɴ.
 • /tmute <ɴɢườɪ ᴅùɴɢ> x(ᴍ /ʜ /ᴅ): ᴄấᴍ ᴛạᴍ ᴛʜờɪ ᴛʀᴏɴɢ x ᴛʜờɪ ɢɪᴀɴ.
 • /unmute <ɴɢườɪ ᴅùɴɢ>: ɢỡ ʙỏ ᴄấᴍ ɴɢʜɪ.
 • /tban <ɴɢườɪ ᴅùɴɢ> x(ᴍ /ʜ /ᴅ): ᴄấᴍ ᴛạᴍ ᴛʜờɪ ᴠớɪ ᴛʜờɪ ɢɪᴀɴ ᴄʜỉ ᴅịɴʜ.
 • /sban <ɴɢườɪ ᴅùɴɢ>: ᴄấᴍ ᴋʜɪᴏɴɢ ᴛʜᴏɴɢ ʙáᴏ.
 • /dban (ᴄʜỉ ᴅùɴɢ ᴛʀả ʟờɪ): ᴛʜᴜ ʜồɪ ᴛɪɴ ɴʜắɴ ᴠà ᴄấᴍ ɴɢườɪ ɢửɪ.

<b>➤ ᴛấᴛ ᴄả ʟệɴʜ ʜỗ ᴛʀợ:</b> ᴛʀả ʟờɪ, @ᴛêɴɴɢườɪᴅùɴɢ, ʜᴏặᴄ ID ɴɢườɪ ᴅùɴɢ
"""
